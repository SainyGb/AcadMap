    ...
    <FormProvider {...methods}>
      ...
      >        
        <div className='col-span-2 flex flex-col items-start'>
          ...
          {errors.event && <p className="text-red-600 text-sm mt-1 text-left">{errors.event.message}</p>}
        </div>        
        
        <div className='flex flex-col items-start'>
          <label htmlFor="cnpq" className="block mb-2 text-sm font-medium text-white text-start">Selecione a área de conhecimento</label>
          <select
            id="cnpq"
          ...
          {errors.cnpq && <p className="text-red-500 text-sm mt-1 text-left">{errors.cnpq.message}</p>}
        </div>        
        ...
        <div className='flex flex-col items-start'>
          ...
          {errors.indice && <p className="text-red-500 text-sm mt-1 text-left">{errors.indice.message}</p>}
        </div>
        ...
        <div className='flex flex-col items-start'>
          ...
          {errors.accessLink && <p className="text-red-500 text-sm mt-1 text-left">{errors.accessLink.message}</p>}
        </div>
        ...
        <div className='flex flex-col items-start'>
          ...
          {errors.repoScholar && <p className="text-red-500 text-sm mt-1 text-left">{errors.repoScholar.message}</p>}
        </div>
        ...
        <div className='flex flex-col items-start'>
          ...
          {errors.repoSolSBC && <p className="text-red-500 text-sm mt-1 text-left">{errors.repoSolSBC.message}</p>}
        </div> 
